...
class BertModel(BertPreTrainedModel):
    ...
    Return:
        ...
        outputs = (sequence_output, pooled_output,) + encoder_outputs[
            1:
        ]  # add hidden_states, attentions, and norms if they are here   # changed by Goro Kobayashi
        return outputs  # sequence_output, pooled_output, (hidden_states), (attentions), (norms)   # changed by Goro Kobayashi
